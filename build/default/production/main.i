...
const uint8_t sin[26] = {128, 187, 213, 233, 248, 255, 255, 248, 233, 213, 187, 159, 128, 97, 69, 43, 23, 8, 1, 1, 8, 23, 43, 69, 97};



uint8_t sdCardBufferRed[512];
uint8_t sdCardBufferBlue[512];

uint8_t collectSamples = 0;
uint8_t redBufferFull = 0;
uint8_t blueBufferFull = 0;
